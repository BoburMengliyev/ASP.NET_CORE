...
namespace Students.Teachers.Api.Migrations
{
    ...
    [Migration("20250807074820_addpasport")]
    partial class addpasport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Students.Teachers.Api.Models.Passport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Students.Teachers.Api.Models.Passport", b =>
                {
                    b.HasOne("Students.Teachers.Api.Models.Student", "Student")
                        .WithOne("Passport")
                        .HasForeignKey("Students.Teachers.Api.Models.Passport", "StudentId")
